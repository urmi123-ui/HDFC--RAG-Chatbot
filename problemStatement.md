...
- Selected Asset Management Company (AMC): HDFC Mutual Fund
- Currently limiting to the following 12 URLs (Groww scheme pages):
...
- Answer facts-only queries, such as:
  ...
  - Fund management data (such as fund manager names, tenure, education, and experience)
- Ensure:
